...
from helpers.thesaurus import Thesaurus
...
from processors.lengthen import Lengthener
from helpers.utils import get_valid_input, validate_choice, validate_file_exists, get_haiku_input
...
7. Exit"""
  ...
  # Handle the lengthen option (Option 6)
  def handle_lengthen(self, haiku_file=None, thesaurus_file=None):
    """Handle lengthen option"""
    retry = True
    ...
    while retry:
      try:
        ...
        if thesaurus_file is None:
          thesaurus_file = get_valid_input(
            "\nSelect a synonym thesaurus file for lengthening.\nPlease enter input file: ",
            validate_file_exists
          )
          input("\nPress Enter to continue...")
        ...
        # Process haiku to lengthen it
        processor = Lengthener(haiku, thesaurus)
        processed = processor.process()
